...
class Ghost(Sprite):
    ...
    def __init__(self, screen, maze, target, spawn_info, sound_manager, ghost_file='ghost-red.png'):
        ...
        self.regular_ghosts = ImageManager(ghost_file, sheet=True, pos_offsets=[(0, 0, 32, 32), (0, 32, 32, 32)],
                                        ...
                                        animation_delay=250)
        self.blue_ghosts = ImageManager('ghost-ppellet.png', sheet=True, pos_offsets=[(0, 0, 32, 32), (0, 32, 32, 32)],
                                        resize=(self.maze.block_size, self.maze.block_size),
                                        animation_delay=150)
        self.blue_ghosts_warning = ImageManager('ghost-ppellet-warn.png', sheet=True, pos_offsets=[(0, 0, 32, 32),
                                                                                             (0, 32, 32, 32)],
                                          resize=(self.maze.block_size, self.maze.block_size),
                                          animation_delay=150)
        self.ghosts_eyes = ImageManager('ghost-eyes.png', sheet=True, pos_offsets=[(0, 0, 32, 32), (32, 0, 32, 32),
