...
class ScoreBoard:
    ...
    def __init__(self, screen, pos=(0, 0)):
        ...
        self.score_font = pygame.font.Font('fonts/LuckiestGuy-Regular.ttf', 36)
        self.image = None
        self.rect = None
        self.prep_image()
        self.pos = pos
...
class ItemCounter:
    def __init__(self, screen, image_name, pos=(0, 0)):
        self.screen = screen
        self.counter = 0
        self.item_font = pygame.font.Font('fonts/LuckiestGuy-Regular.ttf', 36)
        self.color = ScoreBoard.SCORE_WHITE
...
class LevelTransition:
    ...
    def __init__(self, screen, score_controller, transition_time=5000):
        ...
        self.score_font = pygame.font.Font('fonts/LuckiestGuy-Regular.ttf', 32)
