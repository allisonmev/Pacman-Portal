...
class PacManPortalGame:
    ...
    def __init__(self):
        ...
        self.lives_left = PacManCounter(screen=self.game_screen, ct_pos=((self.game_screen.get_width() // 3),
                                                                      (self.game_screen.get_height() * 0.965)),
        ...
        self.pacman_ghosts_sound = SoundManager(sound_files=['ghost-blue.wav', 'ghost-eaten.wav', 'ghost-std.wav'],
                                                keys=['blue', 'eaten', 'std'],
        ...
        self.blit_ghosts()
        self.game_actions = {PacManPortalGame.event_start: self.init_ghosts,
    ...
    def init_ghosts(self):
        if not self.pacman_ghosts_blinky.state['enabled']:
            ...
            pygame.time.set_timer(PacManPortalGame.event_start, self.pacman_ghosts_interval_active)
        else:
            try:
    ...
    def blit_ghosts(self):
        ghost_images_file = ['ghost-pink.png', 'ghost-lblue.png', 'ghost-orange.png', 'ghost-red.png']
        location = 0
